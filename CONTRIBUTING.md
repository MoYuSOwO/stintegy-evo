...
- **Asset Contributions**: Original music, artwork, track data, and other assets submitted and accepted through the normal contribution process are likewise made available to the community under AGPL-3.0. Do not submit through a public Pull Request any material that you intend to keep confidential or prohibit the community from redistributing. Clearly identified third-party material retains its original compatible license and must identify its author, source, and license. See the [Content and Asset Licensing Notice](CONTENT_LICENSE.md).
