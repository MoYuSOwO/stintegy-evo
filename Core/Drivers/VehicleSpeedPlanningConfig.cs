...
public sealed class VehicleSpeedPlanningConfig
{
    ...
    public float ProtectAccelerationUsage { get; init; } = 0.885f;
    public float LightAccelerationUsage { get; init; } = 0.90f;
    public float NormalAccelerationUsage { get; init; } = 0.916f;
    public float PushAccelerationUsage { get; init; } = 0.933f;
    public float AttackAccelerationUsage { get; init; } = 0.95f;
