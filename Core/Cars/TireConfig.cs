...
public sealed class TireConfig
{
    ...
    public const float NearLimitHeatStartUse = 0.90f;
    public const float OverLimitHeatRate = 6f;
    public const float SideslipHeatRate = 4f;
    public const float RollingSurfaceHeatRate = 0.5f;
    public const float RollingCoreHeatRate = 0.05f;
    ...
    public float IdealSurfaceTempHighC { get; init; } = 108f;
    public float ColdGripLossPerC { get; init; } = 0.006f;
    public float HotGripLossPerC { get; init; } = 0.002f;
    public float CoreOverheatTempC { get; init; } = 98f;
    public float CoreOverheatGripLossPerC { get; init; } = 0.005f;
    ...
    public float LateralHeatRate { get; init; } = 1.00f;
    public float LongitudinalHeatRate { get; init; } = 0.45f;
    public float NearLimitHeatGain { get; init; } = 8.0f;
    ...
    public float HotWearStartTempC { get; init; } = 108f;
